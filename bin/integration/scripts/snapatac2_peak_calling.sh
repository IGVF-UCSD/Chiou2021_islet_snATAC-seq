...
#####
# USAGE:
# sbatch --job-name=snapatac2_peak_calling 3_snapatac2_peak_calling.sh
#####
...
script_path=/cellar/users/aklie/data/datasets/igvf_sc-islet_10X-Multiome/bin/data_annotation/snapatac2/pseudobulk_and_peakcalling_snapatac2.py
